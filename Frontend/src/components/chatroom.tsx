...
export function Chatroom(props: params) {
  ...
  return (
    <div className={`h-screen bg-[url('/solidbg.png')] bg-cover bg-center w-full overflow-hidden flex flex-col pt-3 px-4`} >
      <ToastContainer />
      ...
      {username == ''
        ?
        <div className={` flex flex-col glass-container  h-auto gap-5 ${bp=='mp'?'px-8 py-4':'px-5 py-8'} shadow shadow-indigo-400 justify-around rounded-xl items-center w-auto m-auto`}>
          <p className={`flex flex-wrap playwrite-in-bold text-gray-50 ${bp=='mp'?'text-2xl':'text-3xl'} font-semibold`}>Enter a name for yourself that others will see in the room.</p>
        ...
        :
        <div className=" h-[92%] w-full flex flex-col justify-baseline items-center font-sans font-semibold py-1 gap-2 px-0">
